...
if (isset($_POST['btn-insert'])) {
    ...
    $resurt = mysqli_query($conn, "select * from danhmuc where TenDanhMuc = '$danhmuc'");
    if (mysqli_num_rows($resurt) == 0) {
        ...
        $sql = "INSERT INTO danhmuc(TenDanhMuc,AnhCon) VALUES ('$danhmuc','$filename')";
            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="form-insert">
                        <form action="themdanhmuc.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="insert-title">
                                ...
                                <input type="text" name="tendanhmuc" required id="tendanhmuc" title="Sai định dạng" class="input-title" placeholder="Tên danh mục"> <br>
                                <button id="btn-insert" type="submit" name="btn-insert">Thêm</button>
                            </div>
                        </form>
                    </div>
                </div>
